...
public class JwtHelper {
    ...
    public static final long JWT_TOKEN_VALIDITY = 12 * 60 * 60; // 12 hours
    public static final long REFRESH_TOKEN_VALIDITY = 7 * 24 * 60 * 60; // 7 days
    private String secret = "DtEGMXppzY1mikwFyV8ZrkHkctiXPsT2j+fcMBLVawIkWN/cQsFruigRVQKKEsCFKWnkqV0I+Rp3Fl6qE85rkA==";
